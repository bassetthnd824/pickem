...
class DomainDtoJsonTests {
    ...
    void serializesMatchupSnapshots() throws Exception {
        ...
        assertThat(json.path("homeTeam").path("squad").asText()).isEqualTo("Crimson Tide");
        assertThat(json.path("venue").path("cityState").asText()).isEqualTo("Tuscaloosa, AL");
    ...
    void userJsonHasNoPasswordField() throws Exception {
        ...
        assertThat(objectMapper.readTree(json).path("roles").path(0).asText()).isEqualTo("player");
    }
}
