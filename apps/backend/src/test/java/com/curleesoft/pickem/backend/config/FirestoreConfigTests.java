...
class FirestoreConfigTests {
    ...
    void prefersFireStoreEmulatorHostEnvironmentOverProperties() {
        PickemFirestoreProperties properties = new PickemFirestoreProperties("pickem-local", true, "127.0.0.1:9999");
    ...
    void returnsNullWhenEmulatorDisabledAndNoEnv() {
        ...
        PickemFirestoreProperties properties = new PickemFirestoreProperties("prod-project", false, "");
