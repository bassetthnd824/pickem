...
<div class="row">
	<div class="col-sm-12">
		<s:if test="modelList.size > 0">
			<table class="table table-hover">
				...
				<s:iterator value="modelList">
					<s:url action="themes_edit" var="editUrl">
						<s:param name="model.id" value="id"/>
					</s:url>
					<tr>
						<td><s:property value="themeName"/></td>
						<td><s:property value="themePath"/></td>
		...
		<div>
			<a href="<s:url action="themes_add"/>" class="btn btn-small btn-primary add"><span class="glyphicon glyphicon-plus"></span></a>
		</div>
	</div>
</div>